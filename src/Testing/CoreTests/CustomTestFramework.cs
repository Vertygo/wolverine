...
using IMessageBus = Xunit.Sdk.IMessageBus;

[assembly: TestFramework("CoreTests.CustomTestFramework", "CoreTests")]
...
public class CustomTestFramework : XunitTestFramework
{
    ...
    private class CustomTestMethodRunner : XunitTestMethodRunner
    {
        ...
        protected override async Task<RunSummary> RunTestCaseAsync(IXunitTestCase testCase)
        {
            ...
            _diagnosticMessageSink.OnMessage(new DiagnosticMessage($"STARTED: {test} | Process & Thread: {Process.GetCurrentProcess().Id} - {Thread.CurrentThread.ManagedThreadId}"));
